...
class MetaIGBroker(BrokerBase.__class__):
...
class IGBroker(with_metaclass(MetaIGBroker, BrokerBase)):
    ...
    def __init__(self, **kwargs):
        super(IGBroker, self).__init__()

        self.o = igstore.IGStore(**kwargs)
    ...
    def stop(self):
        super(IGBroker, self).stop()
        self.o.stop()

    def getcash(self):
        # This call cannot block if no answer is available from IG
